...
<script>
import Popper from 'topevery-element-ui/src/utils/vue-popper';
...
import Locale from 'topevery-element-ui/src/mixins/locale';
import Migrating from 'topevery-element-ui/src/mixins/migrating';
import ElInput from 'topevery-element-ui/packages/input';
import ElTag from 'topevery-element-ui/packages/tag';
import ElScrollbar from 'topevery-element-ui/packages/scrollbar';
import ElCascaderPanel from 'topevery-element-ui/packages/cascader-panel';
import AriaUtils from 'topevery-element-ui/src/utils/aria-utils';
import { t } from 'topevery-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'topevery-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'topevery-element-ui/src/utils/types';
import { isDef } from 'topevery-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'topevery-element-ui/src/utils/resize-event';
