<template>
  <div :ref="ref" class="cube-border-box-3">
    <svg class="cube-border-svg-container" :width="width" :height="height">
      <defs>
...
.cube-border-box-3 .cube-border-svg-container {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0px;
...
.cube-border-box-3 .cube-border-svg-container polyline {
  fill: none;
  stroke-width: 1;
}
.cube-border-box-3 .border-box-content {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
