...
import { oneOf } from '../../../packages/uitls/assist'
import { on, off } from '../../../packages/uitls/dom'
...
.cube-split-wrapper {
  ...
  .cube-split-pane.left-pane,
  .cube-split-pane.right-pane {
    top: 0;
    bottom: 0;
  }
  .cube-split-pane.left-pane {
  ...
  .cube-split-pane.top-pane,
  .cube-split-pane.bottom-pane {
    left: 0;
    right: 0;
  }
  .cube-split-pane.top-pane {
  ...
  .cube-split-pane-moving {
    user-select: none;
  }
  .cube-split-trigger {
    border: 1px solid #dcdee2;
  }
  .cube-split-trigger-con {
    position: absolute;
    transform: translate(-50%, -50%);
    z-index: 10;
  }

  .cube-split-trigger-bar-con {
    position: absolute;
    overflow: hidden;
    &.vertical {
      top: 50%;
  ...
  .cube-split-horizontal > .cube-split-trigger-con {
    top: 50%;
    height: 100%;
    width: 0;
  }
  .cube-split-vertical > .cube-split-trigger-con {
    left: 50%;
    height: 0;
    width: 100%;
  }

  .cube-split .no-select {
    user-select: none;
  }
}
</style>
