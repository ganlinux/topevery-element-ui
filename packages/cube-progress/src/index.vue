<template>
  <div
    class="el-progress cube-progress"
    :class="[
      'el-progress--' + type,
      status ? 'is-' + status : '',
      {
    ...
    aria-valuemax="100"
  >
    <div v-if="type === 'line'" class="el-progress-bar line-progress">
      <div class="el-progress-bar__outer" :style="{height: strokeWidth + 'px'}">
        <div class="el-progress-bar__inner" :class="active?'active':''" :style="barStyle">
