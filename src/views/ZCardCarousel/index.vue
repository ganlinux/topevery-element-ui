...
export default {
  ...
  methods: {
    ...
    timerResetMessage() {
      ...
      speechSynth.text = `图元科技主要经营项目是：智慧城市设计、建设、运营服务、技术开发；智慧城市相关软件、硬件服务及外围设备、通讯设备销售及售后服务；
      信息系统集成软件的开发、技术服务、运行维护；计算机系统集成；电子产品、通讯产品的设计、制造及销售；安防工程安装；
      视频监控系统、智能系统工程的设计、施工及维护；数据普查；地理信息系统工程；城市管理信息采集服务；物业管理；城市园林绿化管理；
      市场调查；第三方评估调查、信息采集监测、满意度调查和数据统计分析服务；市政设施管理、环境保护领域内技术开发、技术咨询和技术服务；`
      window.speechSynthesis.speak(speechSynth)
    },
    reset() {
      this.resetTimer()
